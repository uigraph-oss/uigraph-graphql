...
type githubImportClient interface {
	...
	GetGitHubImportEnvironment(ctx context.Context, orgID string) (uigraphapi.GitHubImportEnvironment, error)
	CreateRepositoryImportToken(ctx context.Context, orgID, owner, repo string) (string, error)
