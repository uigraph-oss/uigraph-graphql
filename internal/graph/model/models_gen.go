...
type OnboardingProgress struct {
	...
	Runner    *OnboardingRunner `json:"runner,omitempty"`
...
type OnboardingRunner string

const (
	OnboardingRunnerGithubActions OnboardingRunner = "GITHUB_ACTIONS"
)

var AllOnboardingRunner = []OnboardingRunner{
	OnboardingRunnerGithubActions,
}

func (e OnboardingRunner) IsValid() bool {
	switch e {
	case OnboardingRunnerGithubActions:
		return true
	}
	return false
}

func (e OnboardingRunner) String() string {
	return string(e)
}

func (e *OnboardingRunner) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = OnboardingRunner(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid OnboardingRunner", str)
	}
	return nil
}

func (e OnboardingRunner) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *OnboardingRunner) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e OnboardingRunner) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
const (
	OnboardingStepTeam        OnboardingStep = "TEAM"
	OnboardingStepRunner      OnboardingStep = "RUNNER"
	OnboardingStepGithub      OnboardingStep = "GITHUB"
	OnboardingStepRepository  OnboardingStep = "REPOSITORY"
	OnboardingStepEnvironment OnboardingStep = "ENVIRONMENT"
	OnboardingStepRun         OnboardingStep = "RUN"
)

var AllOnboardingStep = []OnboardingStep{
	OnboardingStepTeam,
	OnboardingStepRunner,
	OnboardingStepGithub,
	OnboardingStepRepository,
	OnboardingStepEnvironment,
	OnboardingStepRun,
}

func (e OnboardingStep) IsValid() bool {
	switch e {
	case OnboardingStepTeam, OnboardingStepRunner, OnboardingStepGithub, OnboardingStepRepository, OnboardingStepEnvironment, OnboardingStepRun:
		return true
	}
	return false
}

func (e OnboardingStep) String() string {
	return string(e)
}

func (e *OnboardingStep) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = OnboardingStep(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid OnboardingStep", str)
	}
	return nil
}

func (e OnboardingStep) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *OnboardingStep) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e OnboardingStep) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
